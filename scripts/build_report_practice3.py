...
def build():
    ...
    add_paragraph(doc, "Руководитель от вуза ________________ канд. экон. наук, доц. Н. Ю. Азаренко", indent=False)
    add_paragraph(doc, "Нормоконтроль ______________________ канд. экон. наук, доц. Н. Ю. Азаренко", indent=False)
    add_paragraph(doc, "Доступ к защите «24» 06 2026 г. ___ канд. экон. наук, доц. Н. Ю. Азаренко", indent=False)
    ...
    add_paragraph(doc, "Руководитель практики от вуза: Н. Ю. Азаренко", indent=False)
    ...
    add_paragraph(doc, "Руководитель практики ________________ Н. Ю. Азаренко", indent=False)
